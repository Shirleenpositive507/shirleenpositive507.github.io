---
layout: "default"
title: "🚀 nebula-engine - Create stunning 2D games with ease"
description: "Build 2D games with this C++ engine featuring an entity component system, hardware-accelerated rendering, and integrated physics for rapid development."
---
...
* Memory: 4 GB of RAM.
* Graphics: A display card that supports OpenGL 2.1 or newer.
* Storage: 200 MB of space for the engine files.
...
Anyone who wants to learn game design can use this tool. It is perfect for beginners who want to build platformers, puzzles, or top-down games.

Can I sell the games I build?
Yes. You own the games that you create with this software. There are no fees or royalties required if you choose to sell your work.

What are the limits of this engine?
This engine is built specifically for 2D graphics. It does not support 3D models or advanced 3D shaders. It works best for pixel art and classic 2D game styles.

How do I update the engine?
When a newer version arrives, download the file from the link again. Replace your old files with the new ones. Your project files will remain compatible with the new version.
